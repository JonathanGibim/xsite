    ...
    <form action="<?php echo URL_ATUAL; ?>" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="250" class="form-control" id="nome" name="nome" placeholder="Quem Somos" value="<?php echo $nome; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="250" class="form-control" id="target" name="target" placeholder="_self" value="<?php echo $target; ?>">
            </div>
        </div>
